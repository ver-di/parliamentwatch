...
// set values and labels
    jQuery("#webform-component-fieldset-donationform-yourdonation--donation-amount").click(function() {
        ...
        if (pw_interval == 0 && pw_amount != 'free') {
            ...
            jQuery("#edit-submitted-fieldset-donationform-yourdonation-donation-amount-1 + label").text(pw_interval * 5 + " €");
            jQuery("#edit-submitted-fieldset-donationform-yourdonation-donation-amount-1").val(pw_interval * 5);
            jQuery("#edit-submitted-fieldset-donationform-yourdonation-donation-amount-2 + label").text(pw_interval * 10 + " €");
            jQuery("#edit-submitted-fieldset-donationform-yourdonation-donation-amount-2").val(pw_interval * 10);
            jQuery("#edit-submitted-fieldset-donationform-yourdonation-donation-amount-3 + label").text(pw_interval * 20 + " €");
            jQuery("#edit-submitted-fieldset-donationform-yourdonation-donation-amount-3").val(pw_interval * 20);
        }
