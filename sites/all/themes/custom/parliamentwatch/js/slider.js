jQuery(document).ready(function() {
        ...
        if(jQuery('.view-slider .views-slideshow-controls-top').css('display') != 'block') {
            jQuery('.slider-stage').animate({
                paddingTop: "188px"
                    ...
                    jQuery('#block-views-slider-block .view-slider .views-slideshow-controls-top').fadeIn('slow');
    ...
    jQuery("#views_slideshow_cycle_main_slider-block .close").click(function () {
        ...
        jQuery('#block-views-slider-block .views-slideshow-controls-top').fadeOut('slow', function() {
            jQuery('.slider-stage').animate({
                paddingTop: "0"
            }, 500); 
