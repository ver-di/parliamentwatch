...
?>
<style>
  #views-exposed-form-pw-vote-search-block-2 {
  ...
  #views-exposed-form-pw-vote-search-block-2 .views-submit-button {
    float: right;
    margin-top: 2.5em;
  }
  #views-exposed-form-pw-vote-search-block-2 .form-submit {
    width: 40px;
    height: 40px;
    text-indent: -5000em;
...
@media (max-width: 639px) {
  ...
  #views-exposed-form-pw-vote-search-block-2 .views-exposed-widget {
