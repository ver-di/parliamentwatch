...
<div class="ds-1col <?php print $classes; ?> clearfix">
  ...
  <div id="user_user_search_result_group_grid_6" class="field-group-format group_grid_6 field-group-div group-grid-6 grid-6 omega speed-fast effect-none">
    ...
    <span class="field-questionsget"><?php print ($questions_get)?$questions_get:"0";?> <?php print ($questions_get==1)?'Frage':'Fragen';?></span><?php print ($answers_give)?$answers_give:"0";?> <?php print ($answers_give==1)?'Antwort':'Antworten';?></div>
